# Generated by Django 5.1.7 on 2025-03-30 01:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('kitnet', 'Kitnet'), ('casa', 'Casa'), ('barracao', 'Barracão')], max_length=15)),
                ('categoria', models.CharField(blank=True, choices=[('residencial', 'Residencial'), ('comercial', 'Comercial')], max_length=15, null=True)),
                ('status', models.CharField(choices=[('disponivel', 'Disponível'), ('alugado', 'Alugado'), ('venda', 'Venda')], max_length=15)),
                ('observacoes', models.TextField(blank=True, null=True)),
                ('condominio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='imoveis_diretos_fk', to='administracao.condominio')),
                ('imobiliaria', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='imoveis_diretos', to='administracao.imobiliaria')),
            ],
        ),
        migrations.CreateModel(
            name='Contrato',
            fields=[
                ...
                ('data_pagamento_caucao', models.DateField(blank=True, null=True)),
                ...
                ('data_primeiro_pagamento', models.DateField(blank=True, null=True)),
                ('valor_primeiro_pagamento', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('observacoes', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contrato', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contratos_inquilino', to='administracao.contrato')),
            ],
        ),
        migrations.CreateModel(
            name='Pagamento',
            fields=[
                ...
                ('contrato', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pagamentos', to='administracao.contrato')),
                ('inquilino', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pagamentos_inquilino', to='administracao.pessoa')),
            ],
        ),
        migrations.AddField(
            model_name='imovel',
            name='proprietario',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='administracao.pessoa'),
        ),
        migrations.AddField(
            model_name='contrato',
            name='inquilino',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contratos_inquilino', to='administracao.pessoa'),
        ),
        migrations.AddField(
            model_name='contrato',
            name='proprietario',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contratos_proprietario', to='administracao.pessoa'),
        ),
        migrations.CreateModel(
            name='Renovacao',
            fields=[
